...
[items]
A key is a thing. Key is in Janitor's Closet. The description of key is "Borrowed from the Janitor's Closet. Perhaps it has access to a particular room in building 14.". The key unlocks Game Design Lab.
...
The description of Software Design Lab is "A lab room lined with computers with a projector and table at the center.".
The description of luke_hallway is “To the west there is a staircase, but you have no need to go downstairs. To the south is a door leading outside. In the hallway you see a Storage Room, a Janitor's Closet, the Software Design Lab, the Game Design Lab, the HCI Lab, and a Women's Restroom. The hallway continues to the east.”.
Game Design Lab is locked.
